...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        sessionManager.addExpence("kofee",person1, person2, BigDecimal.valueOf(300));
        sessionManager.addExpence("kofee",person1, person3, BigDecimal.valueOf(300));
        sessionManager.addExpence("kofee",person2, person1, BigDecimal.valueOf(300));
        sessionManager.addExpence("kofee",person2, person3, BigDecimal.valueOf(300));
        sessionManager.addExpence("kofee",person3, person1, BigDecimal.valueOf(300));
        sessionManager.addExpence("kofee",person3, person2, BigDecimal.valueOf(300));
